...
public class Basics {
	...
	static void writeFirstStreamOnly() {
	...
	static void orderStream_intermediate_operation() {
	...
	static void orderStream_terminal_operation() {
	 ...
	 * Optimized
	 */
	static void why_order_matters_2() {
		/*
	...
	static void why_order_matters_order() {
		Stream.of("d2", "a2", "b1", "b3", "c")
				.sorted((s1, s2) -> {
	 ...
	 * Optimized
	 */
	static void why_order_matters_order_2() {
		Stream.of("d2", "a2", "b1", "b3", "c")
				.filter(s -> {
					System.out.println("filter: " + s);
					return s.startsWith("a");
